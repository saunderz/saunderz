...
- **Linguagens:** Python, C++, CUDA, LaTeX  
...
- **Visão Computacional:** OpenCV, YOLOv8, OCR pipelines  
...
- 🎙️ [**TecaAI**](https://github.com/seuusuario/TecaAI) – Assistente de voz educacional com integração a ESP32 e IA para respostas contextualizadas.
- 📚 [**Toth**](https://github.com/seuusuario/ProjetoToth) – Geração de livros ilustrados com numeração, estilos e exportação em PDF/EPUB para distribuição educacional.
- 📝 [**Prometeus**](https://github.com/seuusuario/ProjetoPrometeus) – Correção textual inteligente com OCR (Google Vision) e coesão textual (Cohere) via Streamlit.
